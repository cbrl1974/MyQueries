...
WHERE TABLE_NAME = N'ProductBasePrices'
...
select top 10
  *
from MerchantProductInfo
where merchantid = 645
select id_cie, tracktail, productmall
from Companies
where id_cie in (1513,2551,6169,6620,7878,7905)
select *
from companies
where cie like '%ta appliance%'
select top 10
  *
from users
where id_cie  in (1513,2551,6169,6620,7878,7905)
select *
from categories
where id_category in (36,389)and id_langue = 1
