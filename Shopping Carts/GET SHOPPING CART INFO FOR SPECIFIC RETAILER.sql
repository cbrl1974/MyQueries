...
--Debugging
DECLARE @MerchantIdforDebugForLogs AS INT = 1903;
...
DECLARE @CustomerOrderEmailsHistory AS INT = 1903;
...
DECLARE @merchantshippingexcludeRules AS INT = 1903;
...
--********************Stores********************
DECLARE @MerchantIdforStores AS INT = 1903;
...
--********************Zones********************
DECLARE @MerchantIdforZones AS INT = 1903;
...
DECLARE @MerchantIdforTaxes AS INT = 1903;
...
----********************Warranties********************
DECLARE @MerchantIdforWarranties AS INT = 1903;
...
--********************Cart Options****************************
DECLARE @MerchantIdforCartOptions AS INT = 1903;
...
--*********************merchantcms****************************************
DECLARE @MerchantIdforcms AS INT = 1903;
