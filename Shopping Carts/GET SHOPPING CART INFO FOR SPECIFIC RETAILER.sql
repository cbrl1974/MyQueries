...
DECLARE @CustomerOrderEmailsHistory AS INT = 1804;
...
where merchantid = @MerchantIdforDebugForCartConfigurations
 ...
 --********************texts********************
DECLARE @MerchantIdfortexts AS INT = 1804;
...
-- DECLARE @MerchantIdforProdsWithPrices AS INT = 1804;
...
-- and price is not null
 ...
 --********************Shipping********************
DECLARE @MerchantIdforShipping AS INT = 1804;
select * from merchantshipping where merchant_id =@MerchantIdforShipping



DECLARE @MerchantIdforShippingShippingPricesBYValueRanges AS INT = 1804;
...
DECLARE @MerchantIdforShippingShippingPricesByQuantity AS INT = 1804;
...
DECLARE @MerchantIdforShippingPricesByStoreLocRings AS INT = 1804;
...
DECLARE @MerchantIdforShippingPricesByStoreLocRadio AS INT = 1804;
...
--Deprecated
DECLARE @MerchantIdforShippingPricesShippingPrices AS INT = 1804;
...
DECLARE @merchantshippingIncluderules AS INT = 1804;
...
DECLARE @merchantshippingexcludeRules AS INT = 1804;
...
DECLARE @MERCHANTIDFORE0XCLUSIONS as int = 1804;
...
--********************Stores********************
DECLARE @MerchantIdforStores AS INT = 1804;
...
--********************Zones********************
DECLARE @MerchantIdforZones AS INT = 1804;
...
DECLARE @MerchantIdforTaxes AS INT = 1804;
...
--********************Cart Options****************************
DECLARE @MerchantIdforCartOptions AS INT = 1804;
...
--*********************merchantcms****************************************
DECLARE @MerchantIdforcms AS INT = 1804;
