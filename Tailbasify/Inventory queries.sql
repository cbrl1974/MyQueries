...
select * from datatail20130410.dbo.merchantstoresInventory where merchantid = 2798
...
select * from datatail20130410.dbo.MerchantStores where merchantid =   2798

select * from datatail20130410.dbo.merchantstoresInventory where merchantid = 2798
select * from datatail20130410.dbo.MerchantInventoryStore where merchant_id = 2798

-- update top (1) datatail20130410.dbo.merchantstoresInventory
-- set Quantity = 2
-- where id = 13541219

select * from datatail20130410.dbo.merchantProds where merchant_id = 2798 and productid =   44160
