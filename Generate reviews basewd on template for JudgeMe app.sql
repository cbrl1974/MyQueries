...
DECLARE @TotalLimit as int = 5;
-- 
DECLARE @ReviewsCountOnThisMerchant as int =  (SELECT count(distinct r.ReviewTitle) FROM Reviews r
...
select @ReviewsCountOnThisMerchant
